    ...
    <div className="flex flex-col items-center px-6 py-10 bg-white relative">
      ...
      <div className="flex sm:flex-row flex-col justify-center  gap-x-10 mt-4">
        ...
        <div className="relative left-[-10%] ">
          ...
          <div className="absolute left-20 top-10 z-10  bottom-10 bg-white p-6 w-80 ">
            ...
            <div className="flex flex-row gap-4 mt-4 text-red-500">
              <FaAngleLeft className="text-xl text-black border-2 border-red-500 rounded-full cursor-pointer" />
              <FaAngleRight className="text-xl text-white bg-red-500 rounded-full cursor-pointer" />
            </div>
          </div>
        </div>

        <div className="relative ">
          <div className="w-72 h-67 top-[11%] border-8 border-red-500 overflow-hidden relative z-0">
            <img
              src="/pexels.jpg"
              alt="img"
